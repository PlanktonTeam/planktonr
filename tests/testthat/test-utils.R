testthat::test_that("Correct function output", {
  ...
  testthat::expect_equal(data.frame(Species = c(
    "IncorrectSpecies cf.", "CorrectSpecies1",
    NA, "CorrectSpecies2", "Incorrect spp.,
                                                Incorrect/Species"
  )) %>%
    pr_filter_Species(), data.frame(Species = c("CorrectSpecies1", "CorrectSpecies2")))

  testthat::expect_true(data.frame(
  ...
  testthat::expect_equal(
    ...
    c(
      "Project", "StationName", "StationCode", "TripCode", "Latitude",
