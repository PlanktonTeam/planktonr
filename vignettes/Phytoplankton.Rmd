...
NRSz <- planktonr::pr_get_Indices("NRS", "P") 
...
CPRz <- planktonr::pr_get_Indices("CPR", "P") 
...
p1 <- planktonr::pr_plot_Trends(CPRp, Trend = "Raw", Survey = "CPR", method = "lm", trans = "identity")
...
```{r}
p1 <- planktonr::pr_plot_TimeSeries(CPRp, Survey = "CPR", trans = "identity") + theme(legend.position = "none", axis.title.y = element_blank())

p2 <- planktonr::pr_plot_Climatology(CPRp, Survey = "CPR", Trend = "Month", trans = "identity") + theme(legend.position = "none")

p3 <- planktonr::pr_plot_Climatology(CPRp, Survey = "CPR", Trend = "Year", trans = "identity") + theme(legend.position = "bottom", axis.title.y = element_blank())
