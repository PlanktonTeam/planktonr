...
#' Load CPR Sample data
#'
#' @return A dataframe with CPR Sample data
#' @export
#'
#' @examples
#' df <- getCPRSamps()
...
#  dplyr::mutate(Year = year(SampleDateUTC),
#     Month = month(SampleDateUTC),
#     Day = day(SampleDateUTC),
#     Time_24hr = str_sub(SampleDateUTC, -8, -1)) %>%
#  dplyr::select(c(TripCode, Sample, Latitude:Time_24hr, PCI, Biomass_mgm3))
# return(CPRSamps)
# }

#' Load CPR Phytoplankton Count data
#'
...
#' Load CPR phytoplankon changelog
#'
#' @return A dataframe with CPR Phytoplankton changelog
#' @export
#'
#' @examples
...
#' Load CPR Zooplankton Count
#'
#' @return A dataframe with CPR Zooplankton Count
#' @export
#'
#' @examples
#' df <- getCPRZooCount()
