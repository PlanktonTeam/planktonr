...
pr_relabel <- function(s, style = "ggplot"){
  ...
  relabel_df <- tibble::as_tibble(matrix(c(
    ...
    "CTDSalinity_PSU", rlang::expr(paste("Surface Salinity")), "Surface Salinity", "Salinity",
    "CTDTemperature_degC", rlang::expr(paste("Surface Temperature (","\U00B0","C)")), "Surface Temperature (&#8451;)", "Temperature",
