...
pr_relabel <- function(s, style = "ggplot", named = FALSE, quiet = FALSE){
  ...
  relabel_df <- tibble::as_tibble(matrix(c(
    ...
    "Biovolume_um3L", rlang::expr(paste("Biovolume (mum"^3," L"^-1,")")), "Biovolume (&#181;m<sup>3</sup> L<sup>-1</sup>)", "Phytoplankton Biovolume",
    "BioVolume_um3m3", rlang::expr(paste("Biovolume (mum"^3," m"^-3,")")), "Biovolume (&#181;m<sup>3</sup> m<sup>-3</sup>)", "Phytoplankton Biovolume",
    "Cells_L", rlang::expr(paste("Cells (L"^-1,")")), "Cells (L<sup>-1</sup>)", "Cells",
    "chl_gsm", rlang::expr(paste("Chlorophyll "*italic("a")*" (GSM) (mg m"^-3*")")), "Chlorophyll (GSM) <i>a</i> (mg m<sup>-3</sup>)", "Chlorophyll a",
    "chl_oc3", rlang::expr(paste("Chlorophyll "*italic("a")*" (OC3) (mg m"^-3*")")), "Chlorophyll (OC3) <i>a</i> (mg m<sup>-3</sup>)", "Chlorophyll a",
    "Chla_mgm3", rlang::expr(paste("Chlorophyll "*italic("a")*" (mg m"^-3*")")), "Chlorophyll <i>a</i> (mg m<sup>-3</sup>)", "Chlorophyll a",
    "ChlF_mgm3", rlang::expr(paste("Chlorophyll from fluorescence")), "Chlorophyll from fluorescence", "Chlorophyll from fluorescence",
    "Conductivity_Sm", rlang::expr(paste("Conductivity (S m"^-1,")")), "Conductivity (S m<sup>-1</sup>)", "Conductivity",
    ...
    "CTDChlaF_mgm3", rlang::expr(paste("Surface Chlorophyll from fluorescence")), "Surface Chlorophyll from fluorescence", "Chlorophyll from fluorescence",
    ...
    'DIN_umolL', rlang::expr(paste("Dissolved Inorganic Nitrogen (","\U00B5","mol L"^-1,")")), "Dissolved Inorganic Nitrogen (&#181; mol L<sup>-1</sup>)", "DIN",
    ...
    "TotalChla", rlang::expr("Total Chlorophyll "*italic("a")*" (mg m"^-3*")"), "Total Chlorophyll <i>a</i>, (mg m<sup>-3</sup>)", "Total Chlorophyll a",
