...
pr_relabel <- function(s, style = "ggplot", named = FALSE){
  ...
  relabel_df <- tibble::as_tibble(matrix(c(
    ...
    "chl_gsm", rlang::expr(bquote("Chlorophyll "*italic("a")*" (GSM) (mg m"^-3*")")), "Chlorophyll (GSM) <i>a</i> (mg m<sup>-3</sup>)", "Chlorophyll a",
    "chl_oc3", rlang::expr(bquote("Chlorophyll "*italic("a")*" (OC3) (mg m"^-3*")")), "Chlorophyll (OC3) <i>a</i> (mg m<sup>-3</sup>)", "Chlorophyll a",
    "Chla_mgm3", rlang::expr(bquote("Chlorophyll "*italic("a")*" (mg m"^-3*")")), "Chlorophyll <i>a</i> (mg m<sup>-3</sup>)", "Chlorophyll a",
    ...
    "PigmentChla_mgm3", rlang::expr(bquote("Chlorophyll "*italic("a")*" (mg m"^-3*")")), "Chlorophyll <i>a</i> (mg m<sup>-3</sup>)", "Chlorophyll a",
    ...
    "TotalChla", rlang::expr(bquote("Total Chlorophyll "*italic("a")*" (mg m"^-3*")")), "Total Chlorophyll <i>a</i>, (mg m<sup>-3</sup>)", "Total Chlorophyll a",
