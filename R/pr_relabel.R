...
pr_relabel <- function(s, style = "ggplot"){
  ...
  relabel_df <- tibble::as_tibble(matrix(c(
    ...
    "Nitrate_umolL", rlang::expr(paste("Nitrate (",mu,"mol L"^-1,")")), "Nitrate (&#181; mol L<sup>-1</sup>)", "Nitrate",
    "Nitrite_umolL", rlang::expr(paste("Nitrite (",mu,"mol L"^-1,")")), "Nitrite (&#181; mol L<sup>-1</sup>)", "Nitrite",
    ...
    "Oxygen_umolL", rlang::expr(paste("Oxygen (",mu,"mol L"^-1,")")), "Oxygen (&#181; mol L<sup>-1</sup>)", "Oxygen",
    "Phosphate_umolL", rlang::expr(paste("Phosphate (",mu,"mol L"^-1,")")), "Phosphate (&#181; mol L<sup>-1</sup>)", "Phosphate",
    ...
    "ShannonCopepodDiversity", rlang::expr(paste("Copepod Diversity (Shannons)")), "Copepod Diversity (Shannons)", "Copepod Diversity",
    "ShannonDiatomDiversitycpr", rlang::expr(paste("Diatom Diversity (Shannons)")), "Diatom Diversity (Shannons)", "Diatom Diversity",
    "ShannonDiatomDiversity", rlang::expr(paste("Diatom Diversity (Shannons)")), "Diatom Diversity (Shannons)", "Diatom Diversity",
    "ShannonDinoDiversitycpr", rlang::expr(paste("Dinoflagellate Diversity (Shannons)")), "Dinoflagellate Diversity (Shannons)", "Dinoflagellate Diversity",
    "ShannonDinoDiversity", rlang::expr(paste("Dinoflagellate Diversity (Shannons)")), "Dinoflagellate Diversity (Shannons)", "Dinoflagellate Diversity",
    "ShannonPhytoDiversitycpr", rlang::expr(paste("Phytoplankton Diversity (Shannons)")), "Phytoplankton Diversity (Shannons)", "Phytoplankton Diversity",
    "ShannonPhytoDiversity", rlang::expr(paste("Phytoplankton Diversity (Shannons)")), "Phytoplankton Diversity (Shannons)", "Phytoplankton Diversity",
    "Silicate_umolL", rlang::expr(paste("Silicate (",mu,"mol L"^-1,")")), "Silicate (&#181; mol L<sup>-1</sup>)", "Silicate",
    ...
    "TAlkalinity_umolkg", rlang::expr(paste("TAlkalinity (",mu,"mol kg"^-1,")")), "Total Alkalinity (&#181; mol kg<sup>-1</sup>)", "Total Alkalinity",
    ...
    "Temperature_degC", rlang::expr(paste("Temperature (",degree,"C)")), "Temperature (&#8451;)", "Temperature",
