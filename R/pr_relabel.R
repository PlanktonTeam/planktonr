...
pr_relabel <- function(s, style = "ggplot"){
  ...
  relabel_df <- tibble::as_tibble(matrix(c(
    ...
    "Archaeal_Chlorophyll_Index_KD", rlang::expr(paste("Archaeal Chlorophyll Index")), "Archaeal Chlorophyll Index", "Archaeal Chlorophyll Index",
    ...
    "Bacterial_Chlorophyll_Index_KD", rlang::expr(paste("Bacterial Chlorophyll Index")), "Bacterial Chlorophyll Index", "Bacterial Chlorophyll Index",
    ...
    "CTDChlaF_mgm3", rlang::expr(paste("Chlorophyll from flouresence")), "Chlorophyll from flouresence", "Chlorophyll from flouresence",
    ...
    "Eukaryote_Chlorophyll_Index_KD", rlang::expr(paste("Eukaryote Chlorophyll Index")), "Eukaryote Chlorophyll Index", "Eukaryote Chlorophyll Index",
