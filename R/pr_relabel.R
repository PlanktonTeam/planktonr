...
pr_relabel <- function(s, style = "ggplot", named = FALSE, quiet = FALSE){
  ...
  relabel_df <- tibble::as_tibble(matrix(c(
    ...
    "chl_gsm", rlang::expr("Chlorophyll "*italic("a")*" (GSM) (mg m"^-3*")"), "Chlorophyll (GSM) <i>a</i> (mg m<sup>-3</sup>)", "Chlorophyll a",
    "chl_oc3", rlang::expr("Chlorophyll "*italic("a")*" (OC3) (mg m"^-3*")"), "Chlorophyll (OC3) <i>a</i> (mg m<sup>-3</sup>)", "Chlorophyll a",
    "Chla_mgm3", rlang::expr("Chlorophyll "*italic("a")*" (mg m"^-3*")"), "Chlorophyll <i>a</i> (mg m<sup>-3</sup>)", "Chlorophyll a",
